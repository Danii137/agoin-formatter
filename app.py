...
<p style="color: #2d8b73;">Logo izquierda • Texto derecha</p>
<div>
<span class="feature-badge">✓ Logo flotante</span>
<span class="feature-badge">✓ Texto alineado</span>
</div>
</div>
""", unsafe_allow_html=True)
...
def create_footer_simple(section):
    """Pie: Logo izquierda (inline) + Texto derecha (alineado)"""
    footer = section.footer
    footer.is_linked_to_previous = False
    for para in footer.paragraphs:
        para.clear()

    # PÁRRAFO 1: Logo pequeño inline
    ...
    try:
        ...
        run_logo.add_picture(logo_stream, width=Cm(1.5))
    except:
        pass

    # PÁRRAFO 2: Empresa (ALINEADO DERECHA)
    ...
    para_empresa.paragraph_format.line_spacing = 1.0
    ...
    # PÁRRAFO 3: Contacto (ALINEADO DERECHA)
    para_contacto = footer.add_paragraph()
    para_contacto.alignment = WD_ALIGN_PARAGRAPH.RIGHT
    para_contacto.paragraph_format.space_before = Pt(1)
    para_contacto.paragraph_format.line_spacing = 1.0
...
st.markdown("---")
st.markdown('<p style="text-align: center; color: #1a5c4d; font-weight: 600;">AGOIN v12.0 • Logo izquierda • Texto derecha</p>', unsafe_allow_html=True)
