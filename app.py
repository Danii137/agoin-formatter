...
st.markdown(f'<div class="main-header"><img src="data:image/jpeg;base64,{LOGO_BASE64}" width="70"><h1>AGOIN Formateador</h1><p style="color:#2d8b73">Simple y funcional</p></div>',unsafe_allow_html=True)
...
def create_footer_simple(section):
    ...
    para_logo.paragraph_format.space_before=Pt(8)
