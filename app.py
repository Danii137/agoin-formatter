...
st.markdown(f'<div class="main-header"><img src="data:image/jpeg;base64,{LOGO_BASE64}" width="70"><h1>AGOIN</h1><p style="color:#2d8b73">v21</p></div>',unsafe_allow_html=True)
...
st.markdown("---")
st.markdown('<p style="text-align:center;color:#1a5c4d;font-weight:600">AGOIN v21 FINAL</p>',unsafe_allow_html=True)
