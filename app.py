...
st.markdown(f'<div class="main-header"><img src="data:image/jpeg;base64,{LOGO_BASE64}" width="70"><h1>AGOIN</h1><p style="color:#2d8b73">v23 • Vista previa</p></div>',unsafe_allow_html=True)
...
if doc_content:
    try:
        ...
        if 'docx_buffer' in st.session_state:
            ...
            st.info("💡 Para convertir a PDF, abre el documento en Word y usa 'Guardar como → PDF'")
...
st.markdown("---")
st.markdown('<p style="text-align:center;color:#1a5c4d;font-weight:600">AGOIN v23 FINAL • Vista previa</p>',unsafe_allow_html=True)
